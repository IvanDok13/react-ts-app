...
import { renderThemeProvider } from 'src/__tests__/test-utils/test-utils';
import { describe, expect, it, vi } from 'vitest';

describe('Header', () => {
  it('renders logo, title, and About link', () => {
    renderThemeProvider(<Header onSearch={() => {}} />);
  ...
  it('calls onSearch when SearchBar is used', () => {
    ...
    renderThemeProvider(<Header onSearch={handleSearch} />);
